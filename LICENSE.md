...
Copyright 2026 Yan Adam

This software is source-available under the **PolyForm Noncommercial License
1.0.0**, reproduced in full below. In short: you may read it, run it, modify it
and share it for any noncommercial purpose. **Commercial use requires separate
written permission from the copyright holder.** Open an issue on
<https://github.com/LSRaGeUx/cooking-app> to ask.

Required Notice: Copyright 2026 Yan Adam, https://github.com/LSRaGeUx/cooking-app

To be precise about a word that gets used loosely: this license is
source-available, not open source. The Open Source Definition does not permit a
restriction on commercial use, so a noncommercial clause is by definition
outside it. Everything else people usually mean by open source does apply here.
The source is public, you may fork it, study it, change it, run your own
instance, and redistribute your changes.
