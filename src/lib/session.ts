...
/**
 * Redirects to the login screen when there is no session. First-run seeding
 * happens here rather than on a sign-up hook: Better Auth owns the user table
 * and its lifecycle, and an idempotent ensure cannot be skipped by a user that
